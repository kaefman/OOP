...
int CorrectInput(Vertex& a, Vertex& b, Vertex& c, Vertex& d, int fig) {
	...
	//проверка корректности прямоугольника: равенство противоположных сторон и диагоналей
	if (fig == 2) {
	...
	//проверка корректности равнобедренной трапеции: равенство боковых строн и диагоналей
	if (fig == 3) {
